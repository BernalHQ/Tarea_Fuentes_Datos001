...
public class FRM_MantenimientoEstudiantes extends javax.swing.JFrame {
    ...
    public FRM_MantenimientoEstudiantes(ConexionBD conexion, FRM_Login frm_Login) {
        initComponents();
        this.frm_Login=frm_Login;
        setVisible(false);
        this.setLocation(250, 200);
        controlador_FRM_MantenimientoEstudiantes = new Controlador_FRM_MantenimientoEstudiantes(this, frm_Login,conexion);
